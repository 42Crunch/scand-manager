...
func main() {
	...
	log.Printf("Starting scand manager: NAMESPACE: '%s', PLATFORM_HOST: '%s', SCAND_IMAGE: '%s', SCAND_IMAGE_PULLPOLICY: '%s', EXPIRATION_TIME: '%d'",
		namespace, platformService, scandImage, scandImage_pullPolicy, expirationTimeInt)
